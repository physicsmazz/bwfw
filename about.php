...
<head>
    ...
    <title>Best Price Bed Bug Mattress Covers - About Us Page</title>
...
<div id="container">
    ...
    <div id="innerContainer" class="aboutPage"><?php
        $page = 'about';
        require_once 'includes/header.inc.php'; ?>
    <?php require_once 'includes/leftCol.inc.php'; ?>
    <div id="mainPage">
        <h2>Information page coming soon.</h2>
        <a id="removal" href="" name="removal">Removal Info Coming Soon.</a>
        <a id="protection" href="" name="protection">Protection Info Coming Soon.</a>
    </div>
